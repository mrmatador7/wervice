...
export default function VendorSubscribeForm({
  ...
  const isStep1Valid = useMemo(() => {
    ...
    return true;
  }, [formData.businessName, formData.category, formData.city, formData.whatsapp, formData.email]);
  ...
  const isStep2Valid = useMemo(() => {
    ...
    return true;
  }, [formData.description, formData.consent, images.length]);
    ...
    <div className="max-w-6xl mx-auto">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{currentPrice} DHS</span>
                      </div>
                      <div className="flex justify-between">
      ...
      {currentStep === 2 && (
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 lg:hidden">
          ...
          >
            {isSubmitting ? 'Submitting...' : `Submit — ${currentPrice} DHS / month`}
          </button>
        </div>
      )}
    </div>
