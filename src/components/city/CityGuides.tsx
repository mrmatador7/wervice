...
export default function CityGuides({ city }: CityGuidesProps) {
  const blogPosts = [
    {
      id: '1',
      title: `Wedding Venues in ${city.name}: A Complete Guide`,
    ...
    {
      id: '2',
      title: `Traditional Wedding Customs in ${city.name}`,
    ...
    {
      id: '3',
      title: `Planning Your Dream Wedding in ${city.name}: Tips & Advice`,
