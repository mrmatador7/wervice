    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-wervice-lime focus:border-transparent"
          />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2">
          <input
            ...
            className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-wervice-lime focus:border-transparent"
          />
          <input
            type="number"
            placeholder="Max"
      ...
      {activeFilterCount > 0 && (
        <button
          ...
          className="w-full px-4 py-2 text-sm font-medium text-wv-text bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors"
        >
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-6">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-wv-text">Filters</h3>
        {activeFilterCount > 0 && (
          <button
            onClick={onClearFilters}
            className="text-sm text-wv-sub hover:text-wv-text"
          >
            Clear all
          </button>
        )}
