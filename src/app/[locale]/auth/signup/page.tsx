        ...
        <div className="min-h-screen bg-[#F3F1EE] px-4 py-6 sm:px-6 lg:px-8">
                ...
                <div className="relative z-10 flex h-full flex-col justify-between p-10">
                    ...
                    <div>
                        ...
                        <p className="mt-5 max-w-md text-lg text-[#4A5C74]">
                            Create your account and unlock personalized tools, saved vendors, and planning progress.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex items-center justify-center p-6 sm:p-10">
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="mb-8">
                        <h2 className="text-4xl font-black text-[#11190C]">Create account</h2>
                        <p className="mt-2 text-[#5F6F84]">Join Wervice to plan your perfect wedding.</p>
                    </div>

                    <form onSubmit={handleCustomSignup} className="space-y-5">
                        {/* Name Field */}
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => setSignupData({ 
                                    ...
                                    lastName: e.target.value // Set lastName same as firstName for backward compatibility
                                })}
